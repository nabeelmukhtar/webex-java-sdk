...
/**
 * <p>Java class for lstUserResponse complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="lstUserResponse">
 *   &lt;complexContent>
 *     &lt;extension base="{http://www.webex.com/schemas/2002/06/service}bodyContentType">
 *       &lt;sequence>
 *         &lt;element name="user" type="{http://www.webex.com/schemas/2002/06/service/user}userInstanceType" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "lstUserResponse", propOrder = {
    "user",
    "matchingRecords"
})
public class LstUserResponse
    extends BodyContentType
    implements Serializable
{

    private final static long serialVersionUID = 2461660169443089969L;
    protected List<UserInstanceType> user;
     ...
     * {@link UserInstanceType }
     * 
     * 
     */
    public List<UserInstanceType> getUser() {
        if (user == null) {
            user = new ArrayList<UserInstanceType>();
        }
        return this.user;
    }
