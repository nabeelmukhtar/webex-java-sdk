...
/**
 * <p>Java class for lstProductsResponse complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="lstProductsResponse">
 *   &lt;complexContent>
 ...
 *         &lt;element name="product" type="{http://www.webex.com/schemas/2002/06/service/sales}productInstanceType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "lstProductsResponse", propOrder = {
    "matchingRecords",
    "product"
})
public class LstProductsResponse
    extends BodyContentType
{
    ...
    public List<ProductInstanceType> getProduct() {
        if (product == null) {
            product = new ArrayList<ProductInstanceType>();
        }
        return this.product;
    }
