...
/**
 * <p>Java class for lstrecordedEventResponse complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="lstrecordedEventResponse">
 *   &lt;complexContent>
 ...
 *         &lt;element name="event" type="{http://www.webex.com/schemas/2002/06/service/event}recordedEventsType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "lstrecordedEventResponse", propOrder = {
    "matchingRecords",
    "event"
})
public class LstrecordedEventResponse
    ...
    implements Serializable
{
    ...
    protected List<RecordedEventsType> event;
     ...
     * {@link RecordedEventsType }
     * 
     * 
     */
    public List<RecordedEventsType> getEvent() {
        if (event == null) {
            event = new ArrayList<RecordedEventsType>();
        }
        return this.event;
    }
