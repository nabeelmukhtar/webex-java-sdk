...
public class AndTestType implements Serializable
{
    ...
    protected List<Serializable> variableTestOrAndTestOrOrTest;
     ...
     * 
     */
    public List<Serializable> getVariableTestOrAndTestOrOrTest() {
        if (variableTestOrAndTestOrOrTest == null) {
            variableTestOrAndTestOrOrTest = new ArrayList<Serializable>();
        }
