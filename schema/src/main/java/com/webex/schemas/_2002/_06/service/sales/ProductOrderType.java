 ...
 *       &lt;sequence>
 *         &lt;element name="orderBy" type="{http://www.webex.com/schemas/2002/06/service/sales}productOrderByType" maxOccurs="3" minOccurs="0"/>
...
public class ProductOrderType {
    ...
    protected List<ProductOrderByType> orderBy;
     ...
     * {@link ProductOrderByType }
     * 
     * 
     */
    public List<ProductOrderByType> getOrderBy() {
        if (orderBy == null) {
            orderBy = new ArrayList<ProductOrderByType>();
        }
        return this.orderBy;
    }
