...
/**
 * <p>Java class for orderMCHisType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="orderMCHisType">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="orderBy" type="{http://www.webex.com/schemas/2002/06/service/history}orderMCHisByType" maxOccurs="3" minOccurs="0"/>
...
@XmlType(name = "orderMCHisType", propOrder = {
    "orderBy",
    "orderAD"
})
public class OrderMCHisType {

    protected List<OrderMCHisByType> orderBy;
     ...
     * {@link OrderMCHisByType }
     * 
     * 
     */
    public List<OrderMCHisByType> getOrderBy() {
        if (orderBy == null) {
            orderBy = new ArrayList<OrderMCHisByType>();
        }
        return this.orderBy;
    }
