...
/**
 * <p>Java class for lstsummaryEventResponse complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="lstsummaryEventResponse">
 *   &lt;complexContent>
 ...
 *         &lt;element name="event" type="{http://www.webex.com/schemas/2002/06/service/event}eventSummaryInstanceType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "lstsummaryEventResponse", propOrder = {
    "matchingRecords",
    "event"
})
    ...
    implements Serializable
{
    ...
    protected List<EventSummaryInstanceType> event;
     ...
     * {@link EventSummaryInstanceType }
     * 
     * 
     */
    public List<EventSummaryInstanceType> getEvent() {
        if (event == null) {
            event = new ArrayList<EventSummaryInstanceType>();
        }
        return this.event;
    }
