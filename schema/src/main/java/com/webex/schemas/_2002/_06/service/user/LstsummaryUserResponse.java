...
/**
 * <p>Java class for lstsummaryUserResponse complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="lstsummaryUserResponse">
 *   &lt;complexContent>
 *     &lt;extension base="{http://www.webex.com/schemas/2002/06/service}bodyContentType">
 *       &lt;sequence>
 *         &lt;element name="user" type="{http://www.webex.com/schemas/2002/06/service/user}userSummaryInstanceType" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "lstsummaryUserResponse", propOrder = {
    "user",
    "matchingRecords"
})
public class LstsummaryUserResponse
    extends BodyContentType
    implements Serializable
{

    private final static long serialVersionUID = 2461660169443089969L;
    protected List<UserSummaryInstanceType> user;
     ...
     * {@link UserSummaryInstanceType }
     * 
     * 
     */
    public List<UserSummaryInstanceType> getUser() {
        if (user == null) {
            user = new ArrayList<UserSummaryInstanceType>();
        }
        return this.user;
    }
