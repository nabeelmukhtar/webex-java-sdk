...
/**
 * <p>Java class for lstsummarySessionResponse complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="lstsummarySessionResponse">
 *   &lt;complexContent>
 ...
 *         &lt;element name="session" type="{http://www.webex.com/schemas/2002/06/service/ep}sessionSummaryInstanceType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "lstsummarySessionResponse", propOrder = {
    "matchingRecords",
    "session"
})
public class LstsummarySessionResponse
    ...
    implements Serializable
{
    ...
    protected List<SessionSummaryInstanceType> session;
     ...
     * {@link SessionSummaryInstanceType }
     * 
     * 
     */
    public List<SessionSummaryInstanceType> getSession() {
        if (session == null) {
            session = new ArrayList<SessionSummaryInstanceType>();
        }
        return this.session;
    }
