...
/**
 * The Class EventSessionServiceExample.
 */
public class EventSessionServiceExample {
	...
	public static void main(String[] args) {
		...
		EventSessionService service = factory.createEventSessionService();
		System.out.println(service.getEvent(1L));
	}
}
